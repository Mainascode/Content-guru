  ...
  return (
    <div className="bg-gradient-to-br from-white to-blue-50 min-h-screen px-6 py-12">
      ...
      <section className="text-center mb-16 max-w-5xl mx-auto flex flex-col md:flex-row items-center">
        ...
        <div>
          <h2 className="text-3xl font-semibold text-gray-800 mb-4">
            Hello! I'm <span className="text-blue-600 font-bold">Maureen</span>, a Professional Virtual Assistant & Social Media Manager
          </h2>
      ...
      <section className="bg-white rounded-xl shadow-md p-8 mb-16 max-w-5xl mx-auto">
        <h3 className="text-2xl font-bold text-blue-700 mb-6 text-center">My Background & Experience</h3>
        <p className="text-gray-700 text-lg mb-6">
          With over <strong>[6]</strong> years of experience, I’ve collaborated with startups, coaches, and ecommerce brands to manage tasks, grow engagement, and implement streamlined workflows. I thrive in dynamic environments and love helping others succeed.
        </p>

        <div className="text-left">
          <h4 className="font-semibold text-gray-800 mb-3">Areas I specialize in:</h4>
      ...
      <section className="bg-white rounded-xl shadow-md p-8 mb-16 max-w-5xl mx-auto">
        <h3 className="text-2xl font-bold text-blue-700 mb-6 text-center">How I Help Businesses Grow Online</h3>
