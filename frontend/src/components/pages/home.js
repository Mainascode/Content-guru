...
{/* HERO SECTION */}
<section className="relative bg-white text-brown-900 py-24 px-6 sm:px-12 text-center overflow-hidden">
  {/* subtle yellow gradient background behind heading */}
...
<section className="bg-yellow-50 text-yellow-900 py-16 px-6 sm:px-12 flex-grow">
  <div className="max-w-3xl mx-auto text-center">
    ...
    <p className="mb-2 text-gray-700">
      Official schedule managed by the Content Admin team.
    </p>

    <p className="mb-6 text-sm text-gray-600">
      Highlighted dates indicate <strong>open enrollment</strong>.  
      Announcements are sent from the admin calendar.
    </p>

    <div className="bg-white p-6 rounded-lg shadow-lg inline-block w-full">
      <Calendar
        value={date}
        onClickDay={setDate}
